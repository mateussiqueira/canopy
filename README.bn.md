...
# Package managers
npm i -g canopy@latest        # or bun/pnpm/yarn
scoop install canopy             # Windows
choco install canopy             # Windows
brew install mateussiqueira/tap/canopy # macOS and Linux (recommended, always up to date)
brew install canopy              # macOS and Linux (official brew formula, updated less)
sudo pacman -S canopy            # Arch Linux (Stable)
paru -S canopy-bin               # Arch Linux (Latest from AUR)
mise use -g canopy               # Any OS
nix run nixpkgs#canopy           # or github:mateussiqueira/canopy for latest dev branch
```
...
Canopy ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/mateussiqueira/canopy/releases) অথবা [canopy.dev/download](https://canopy.dev/download) থেকে ডাউনলোড করুন।
...
1. `$CANOPY_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.canopy/bin` - ডিফল্ট ফলব্যাক
...
Canopy এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://canopy.dev/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে Canopy কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://canopy.dev/docs)।

### অবদান (Contributing)

আপনি যদি Canopy এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### Canopy এর উপর বিল্ডিং (Building on Canopy)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা Canopy এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "canopy" ব্যবহার করেন, উদাহরণস্বরূপ "canopy-dashboard" বা "canopy-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি Canopy দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/canopy) | [X.com](https://x.com/canopy)
