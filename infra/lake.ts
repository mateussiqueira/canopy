...
const tableBucketName = `canopy-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `canopy-${$app.stage}-lake-ingest`,
    destination: "iceberg",
