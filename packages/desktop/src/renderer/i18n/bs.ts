export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Canopy-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Canopy-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
