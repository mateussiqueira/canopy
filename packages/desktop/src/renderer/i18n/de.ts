export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Canopy",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Canopy wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
