export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Canopy",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Canopy a été téléchargée. Voulez-vous l'installer et redémarrer ?",
