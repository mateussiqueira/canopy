export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Canopy",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Canopy. ¿Quieres instalarla y reiniciar?",
