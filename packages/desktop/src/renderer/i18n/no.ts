export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Canopy",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Canopy er lastet ned. Vil du installere den og starte på nytt?",
