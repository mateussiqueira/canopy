export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Canopy",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Canopy er blevet downloadet. Vil du installere den og genstarte?",
