...
import {
  ...
  useCommand,
  useWslServers,
} from "@canopystack/app"
import type { UpdaterState } from "@canopystack/app/updater"
    ...
    integrations: (integrations) => {
      return integrations.filter(
        (i) =>
          i.name !== "Breadcrumbs" &&
          !(
            import.meta.env.CANOPY_CHANNEL === "prod" &&
...
const emitDeepLinks = (urls: string[]) => {
  ...
  window.__CANOPY__ ??= {}
  const pending = window.__CANOPY__.deepLinks ?? []
  window.__CANOPY__.deepLinks = [...pending, ...urls]
