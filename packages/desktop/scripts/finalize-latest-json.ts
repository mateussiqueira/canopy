...
const releaseId = process.env.CANOPY_RELEASE
if (!releaseId) throw new Error("CANOPY_RELEASE is required")

const version = process.env.CANOPY_VERSION
if (!version) throw new Error("CANOPY_VERSION is required")
