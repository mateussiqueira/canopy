import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@canopystack/sdk/v2"
import { SessionTurn } from "@canopystack/ui/session-turn"
import { SessionReview } from "@canopystack/ui/session-review"
import { DataProvider } from "@canopystack/ui/context"
import { FileComponentProvider } from "@canopystack/ui/context/file"
import { WorkerPoolProvider } from "@canopystack/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@canopystack/ui/logo"
import { IconButton } from "@canopystack/ui/icon-button"
import { ProviderIcon } from "@canopystack/ui/provider-icon"
import { iife } from "@canopystack/core/util/iife"
import { Binary } from "@canopystack/core/util/binary"
import { NamedError } from "@canopystack/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@canopystack/ui/tabs"
import { MessageNav } from "@canopystack/ui/message-nav"
import { FileSSR } from "@canopystack/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@canopystack/ui/pierre/worker").then((m) => ({
