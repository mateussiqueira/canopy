---
title: Share
description: Share your Canopy conversations.
---

Canopy's share feature allows you to create public links to your Canopy conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Canopy:
...
Canopy supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Canopy uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
