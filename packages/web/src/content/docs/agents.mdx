...
The model ID in your Canopy config uses the format `provider/model-id`. For example, if you're using [Canopy Zen](/docs/zen), you would use `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
