...
You can add custom commands through the Canopy config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Canopy [config](/docs/config):
