...
[**Canopy**](/) is an AI coding agent — a fork of [Canopy](https://github.com/anomalyco/opencode) with focus on **token economy**, **model routing**, and **modular skills**.
...
Canopy keeps everything great about Canopy and adds:
...
- **System prompts**: 66% shorter than stock Canopy — same instructions, fewer tokens
