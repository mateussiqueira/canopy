...
You can also grab the binary from the [Releases](https://github.com/mateussiqueira/canopy/releases).
...
1. Run the `/connect` command in the TUI, select opencode, and head to [canopy.dev/auth](https://canopy.dev/auth).
...
Here's an [example conversation](https://canopy.dev/s/4XP1fce5) with OpenCode.
