...
1. Run the `/connect` command in the TUI, select `OpenCode Zen`, and head to [canopy.dev/auth](https://canopy.dev/zen).
...
1. Run the `/connect` command in the TUI, select `OpenCode Go`, and head to [canopy.dev/auth](https://canopy.dev/zen).
