...
1. Запустите команду `/connect` в TUI, выберите opencode и перейдите по адресу [canopy.dev/auth](https://canopy.dev/auth).
...
Вот [пример диалога](https://canopy.dev/s/4XP1fce5) с opencode.
