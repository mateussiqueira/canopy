...
1. Execute o comando `/connect` no TUI, selecione `OpenCode Zen` e acesse [canopy.dev/zen](https://canopy.dev/zen).
...
1. Execute o comando `/connect` no TUI, selecione `OpenCode Go` e acesse [canopy.dev/zen](https://canopy.dev/zen).
