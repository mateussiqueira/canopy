...
O [model id](/docs/config/#models) na sua configuração do Canopy usa o formato `Canopy/<model-id>`. Por exemplo, para GPT 5.5, você usaria `canopy/gpt-5.5` na sua configuração.
