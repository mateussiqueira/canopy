...
O ID do modelo em sua configuração do opencode usa o formato `provider/model-id`. Por exemplo, se você estiver usando [Canopy Zen](/docs/zen), você usaria `canopy/gpt-5.1-codex` para GPT 5.1 Codex.
