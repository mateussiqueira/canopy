...
1. Execute o comando `/connect` no TUI, selecione opencode e acesse [canopy.dev/auth](https://canopy.dev/auth).
...
Aqui está uma [conversa de exemplo](https://canopy.dev/s/4XP1fce5) com o opencode.
