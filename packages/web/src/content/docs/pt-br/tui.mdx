---
title: TUI
description: Usando a interface de usuário de terminal Canopy.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O Canopy fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar Canopy inicia o TUI para o diretório atual.
...
Ao usar o TUI do Canopy, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao Canopy. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do Canopy. _Aliases_: `/quit`, `/q`
...
Isso é separado do `canopy.json.guard`, que configura o comportamento do servidor/runtime.
...
- `leader_timeout` - Controla por quanto tempo o Canopy espera depois da leader key. O padrão é `2000`.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `Canopy.default`.
