...
description: Verwenden Sie Canopy in jedem ACP-kompatiblen Editor.
---

Canopy unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um Canopy über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `canopy acp`.

Der Befehl startet Canopy als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „Canopy“ in der AI Chat Agent Selector.
...
Um Canopy als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass Canopy als ACP-Agent für den Chat verwendet wird.
...
Canopy funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer Canopy-Konfiguration konfiguriert sind
