...
Die Modell-ID in Ihrer Canopy-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [Canopy Zen](/docs/zen) verwenden, würden Sie `opencode/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
