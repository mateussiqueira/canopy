...
Die [Modell-ID](/docs/config/#models) in deiner Canopy Config verwendet das Format `Canopy-go/<model-id>`. Für Kimi K2.7 Code würdest du beispielsweise `Canopy-go/kimi-k2.7-code` in deiner Config verwenden.
