---
title: Teilen
description: Teile Canopy-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Canopy-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Canopy Folgendes:
...
Canopy hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Canopy den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`canopy.json.guard` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du Canopy in deiner Organisation einsetzt.
