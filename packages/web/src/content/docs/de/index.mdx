...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie OpenCode aus und gehen Sie zu [canopy.dev/auth](https://canopy.dev/auth).
...
Hier ist ein [Beispielgespräch](https://canopy.dev/s/4XP1fce5) mit OpenCode.
