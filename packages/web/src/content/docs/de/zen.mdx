...
Die [Model-ID](/docs/config/#models) in deiner Canopy-Konfiguration verwendet das Format `Canopy/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `canopy/gpt-5.5` in deiner Konfiguration verwenden.
