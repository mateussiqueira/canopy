...
Hier ist der vollständige ID `provider_id/model_id`. Wenn Sie beispielsweise [Canopy Zen](/docs/zen) verwenden, würden Sie `opencode/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
