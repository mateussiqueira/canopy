...
[model id](/docs/config/#models) ใน Canopy config ของคุณจะใช้รูปแบบ `Canopy-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K2.7 Code คุณจะใช้ `Canopy-go/kimi-k2.7-code` ใน config ของคุณ
