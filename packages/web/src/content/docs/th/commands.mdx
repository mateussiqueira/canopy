...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Canopy:
...
- ระดับผู้ใช้ (Global): `~/.config/Canopy/commands/`
- ระดับโปรเจ็กต์: `.Canopy/commands/`
...
Canopy มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
