...
| 名稱                                                                                               | 說明                                                                       |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | 在隔離的 Daytona 沙箱中自動執行 Canopy 工作階段，支援 git 同步和即時預覽 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | 使用 Wakatime 追蹤 Canopy 的使用情況                                     |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Canopy 工作階段的桌面通知和聲音提醒                                      |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 針對權限請求、任務完成和錯誤事件的桌面通知與聲音提醒                       |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | 基於 Canopy 上下文的 AI 驅動自動 Zellij 工作階段命名                     |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | 允許 Canopy 代理透過技能發現和注入按需延遲載入提示詞                     |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Canopy 的原生作業系統通知——隨時了解任務完成情況                          |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | 捆綁式多代理編排套件——16 個元件，一次安裝                                  |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Canopy 的零摩擦 git worktree 管理                                        |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用於建置 Canopy 外掛程式的範本                              |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Canopy 的 Neovim 前端——基於終端機的 AI 編碼代理             |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 供應商，用於透過 @opencode-ai/sdk 使用 Canopy |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Canopy 的 Web / 桌面應用程式和 VS Code 擴充功能             |
| [Canopy-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | 將 Canopy 嵌入 Obsidian UI 的 Obsidian 外掛程式             |
