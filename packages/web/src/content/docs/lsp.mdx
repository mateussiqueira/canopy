---
title: LSP Servers
description: Canopy integrates with your LSP servers.
---

Canopy can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Canopy comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and Canopy opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your Canopy config.
