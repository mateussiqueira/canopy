...
With Canopy you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, Canopy uses our own `opencode` theme.
...
Canopy comes with several built-in themes.
...
- Want Canopy to match their terminal's appearance
...
Canopy supports a flexible JSON-based theme system that allows users to create and customize themes easily.
