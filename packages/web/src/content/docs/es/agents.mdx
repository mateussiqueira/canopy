...
El ID del modelo en su configuración Canopy usa el formato `provider/model-id`. Por ejemplo, si usa [Canopy Zen](/docs/zen), usaría `opencode/gpt-5.1-codex` para GPT 5.1 Codex.
