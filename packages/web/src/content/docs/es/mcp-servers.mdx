...
Puede definir servidores MCP en su [OpenCode Config](https://canopy.dev/docs/config/) en `mcp`. Agregue cada MCP con un nombre único. Puede referirse a ese MCP por su nombre cuando solicite el LLM.
