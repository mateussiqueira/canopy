...
1. Ejecute el comando `/connect` en TUI, seleccione opencode y diríjase a [canopy.dev/auth](https://canopy.dev/auth).
...
La función [Sesiones](https://docs.helicone.ai/features/sessions) de Helicone le permite agrupar solicitudes LLM relacionadas. Utilice el complemento [opencode-helicone-session](https://github.com/H2Shami/opencode-helicone-session) para registrar automáticamente cada conversación Canopy como una sesión en Helicone.
...
:::tip
Ollama puede configurarse automáticamente para Canopy. Consulte los [documentos de integración de Ollama](https://docs.ollama.com/integrations/opencode) para obtener más detalles.
:::
