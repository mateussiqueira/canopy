...
1. TUI で `/connect` コマンドを実行し、`OpenCode Zen` を選択して、[canopy.dev/zen](https://canopy.dev/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`OpenCode Go` を選択して、[canopy.dev/zen](https://canopy.dev/zen) にアクセスします。
