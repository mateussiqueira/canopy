...
Brug den til at bygge integrasjoner og kontrollere Canopy programmatisk.
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `canopy.json.guard`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av Canopy, kan du oprete en klientforekomst for at koble til den:
