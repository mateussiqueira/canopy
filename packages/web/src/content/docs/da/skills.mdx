...
Agentferdigheter lar Canopy oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Canopy opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Canopy viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `canopy.json.guard`:
