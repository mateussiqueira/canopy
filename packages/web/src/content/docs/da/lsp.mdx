---
title: LSP-servere
description: Canopy integreres med dine LSP-servere.
---

Canopy kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Canopy leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og Canopy åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din Canopy-konfiguration.
