---
title: TUI
description: Brug af Canopy-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Canopy giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Canopy starter TUI for den nuværende mappe.
...
Når du bruger Canopy TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Canopy. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Canopy. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `canopy.json.guard`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Canopy venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `Canopy.default`.
