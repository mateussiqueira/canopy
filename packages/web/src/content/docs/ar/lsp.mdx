---
title: خوادم LSP
description: يتكامل Canopy مع خوادم LSP لديك.
---

يمكن أن يتكامل Canopy مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Canopy مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح Canopy لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات Canopy.
