...
يستخدم [model id](/docs/config/#models) في إعدادات Canopy لديك التنسيق `Canopy-go/<model-id>`. على سبيل المثال، بالنسبة إلى Kimi K2.7 Code، ستستخدم `Canopy-go/kimi-k2.7-code` في إعداداتك.
