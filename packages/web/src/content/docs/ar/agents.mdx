...
يستخدم معرّف النموذج في إعدادات Canopy الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Canopy Zen](/docs/zen)، فستستخدم `opencode/gpt-5.1-codex` لـ GPT 5.1 Codex.
