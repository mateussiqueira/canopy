---
title: دعم ACP
description: استخدم Canopy في أي محرر متوافق مع ACP.
---

يدعم Canopy بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام Canopy عبر ACP، اضبط محررك ليشغّل الأمر `canopy acp`.

يشغّل هذا الأمر Canopy كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'Canopy' من محدد الوكلاء في AI Chat.
...
لاستخدام Canopy كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام Canopy كوكيل ACP للدردشة.
...
يعمل Canopy عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات Canopy
