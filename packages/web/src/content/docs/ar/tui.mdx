---
title: TUI
description: استخدام واجهة المستخدم TUI في Canopy.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Canopy واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Canopy إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Canopy في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Canopy. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Canopy. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `canopy.json.guard`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Canopy بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `Canopy.default`.
