...
Kreiraj `.Canopy/commands/test.md`:
...
Možete dodati prilagođene komande kroz Canopy konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Canopy [config](/docs/config):
...
- Globalno: `~/.config/Canopy/commands/`
- Po projektu: `.Canopy/commands/`
...
Canopy uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
