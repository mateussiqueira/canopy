...
ID modela u vašoj Canopy konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [Canopy Zen](/docs/zen), koristili biste `opencode/gpt-5.1-codex` za GPT 5.1 Codex.
