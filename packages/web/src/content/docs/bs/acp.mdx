---
title: ACP podrška
description: Koristite Canopy u bilo kojem uređivaču kompatibilnom sa ACP.
---

Canopy podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili Canopy putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `canopy acp`.

Naredba pokreće Canopy kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "Canopy" agenta u AI Chat agent selektoru.
...
Da koristite Canopy kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi Canopy kao ACP chat agenta.
...
Canopy radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj Canopy konfiguraciji
