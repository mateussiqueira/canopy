---
title: SDK
description: Type-safe JS klijent za Canopy server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Canopy JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje Canopy-om.
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `canopy.json.guard`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu Canopy instancu, mozete napraviti klijentsku instancu i povezati se na nju:
