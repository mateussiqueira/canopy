---
title: TUI
description: Korištenje korisničkog interfejsa Canopy terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Canopy pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Canopy pokreće TUI za trenutni direktorij.
...
Kada koristite Canopy TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Canopy. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Canopy. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `canopy.json.guard`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Canopy čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `Canopy.default`.
