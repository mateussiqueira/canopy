...
| 名称                                                                                               | 描述                                                                   |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | 在隔离的 Daytona 沙箱中自动运行 Canopy 会话，支持 git 同步和实时预览 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | 使用 Wakatime 追踪 Canopy 的使用情况                                 |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Canopy 会话的桌面通知和声音提醒                                      |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 针对权限请求、任务完成和错误事件的桌面通知与声音提醒                   |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | 基于 Canopy 上下文的 AI 驱动自动 Zellij 会话命名                     |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | 允许 Canopy 代理通过技能发现和注入按需延迟加载提示词                 |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Canopy 的原生操作系统通知——随时了解任务完成情况                      |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用于构建 Canopy 插件的模板                                  |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Canopy 的 Neovim 前端——基于终端的 AI 编码代理               |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 提供商，用于通过 @opencode-ai/sdk 使用 Canopy |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Canopy 的 Web / 桌面应用和 VS Code 扩展                     |
| [Canopy-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | 将 Canopy 嵌入 Obsidian UI 的 Obsidian 插件                 |
