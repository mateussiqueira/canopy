...
Modellen ID i Canopy-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Canopy Zen](/docs/zen), vil du bruke `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
