---
title: TUI
description: Bruke Canopy-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Canopy gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Canopy starter TUI for gjeldende katalog.
...
Når du bruker Canopy TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Canopy. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Canopy. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `canopy.json.guard`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Canopy venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `Canopy.default`.
