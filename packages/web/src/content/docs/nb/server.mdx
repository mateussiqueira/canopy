...
Kommandoen `opencode serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en Canopy-klient kan bruke.
...
Canopy TUI kjører, vil `opencode serve` starte en ny server.
