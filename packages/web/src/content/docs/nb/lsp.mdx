---
title: LSP-servere
description: Canopy integreres med LSP-serverne dine.
---

Canopy kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Canopy kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og Canopy åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Canopy-konfigurasjonen.
