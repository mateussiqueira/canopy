---
title: Özel Araçlar
description: LLM'un Canopy'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. Canopy'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.Canopy/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/Canopy/tools/` içine yerleştirerek.
