---
title: Paylasim
description: Canopy konusmalarini genel baglantilarla paylasin.
---

Canopy'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda Canopy:
...
Canopy, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak Canopy manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `canopy.json.guard` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda Canopy kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
