---
title: Zen
description: Canopy tarafından sağlanan seçilmiş modeller listesi.
---
...
Canopy Zen, Canopy ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Canopy'daki diğer sağlayıcılar gibi çalışır. Canopy Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Canopy kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Canopy ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Canopy Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Canopy Zen, Canopy'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Canopy Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Canopy Zen'i seçin ve API anahtarınızı yapıştırın.
...
Canopy yapılandırmanızdaki [model id](/docs/config/#models) `Canopy/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `canopy/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Canopy'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Canopy'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Canopy'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Canopy'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Canopy'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Canopy Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Canopy ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
