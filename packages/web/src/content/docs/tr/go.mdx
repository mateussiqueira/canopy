...
Canopy yapılandırmanızdaki [model id](/docs/config/#models) formatı `Canopy-go/<model-id>` şeklindedir. Örneğin, Kimi K2.7 Code için yapılandırmanızda `Canopy-go/kimi-k2.7-code` kullanmalısınız.
