...
Puoi aggiungere comandi personalizzati tramite la config di Canopy o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Canopy:
...
- Globale: `~/.config/Canopy/commands/`
- Per progetto: `.Canopy/commands/`
...
Canopy include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
