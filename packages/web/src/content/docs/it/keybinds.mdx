...
Il campo di input del prompt nell'app desktop di Canopy supporta scorciatoie comuni in stile Readline/Emacs per modificare il testo. Sono integrate e al momento non configurabili tramite `opencode.json`.
