---
title: Server LSP
description: Canopy si integra con i tuoi server LSP.
---

Canopy può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Canopy include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e Canopy apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di Canopy.
