...
L'ID modello nella configurazione Canopy usa il formato `provider/model-id`. Per esempio, se stai usando [Canopy Zen](/docs/zen), useresti `opencode/gpt-5.1-codex` per GPT 5.1 Codex.
