...
| 이름                                                                                               | 설명                                                                                            |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | git sync와 live preview를 지원하는 격리된 Daytona sandbox에서 Canopy 세션을 자동 실행합니다.  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime으로 Canopy 사용량을 추적합니다.                                                      |
...
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Canopy 세션에 데스크톱 알림과 사운드 알림을 제공합니다.                                       |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | permission, 완료, 오류 이벤트에 대한 데스크톱 알림과 사운드 알림을 제공합니다.                  |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Canopy 맥락을 기반으로 Zellij session 이름을 AI로 자동 지정합니다.                            |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | skill 탐색과 주입을 통해 Canopy agent가 필요 시 prompt를 lazy load하도록 합니다.              |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Canopy 작업 완료 시점을 native OS 알림으로 알려줍니다.                                        |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Canopy용 git worktree를 손쉽게 사용할 수 있도록 돕습니다.                                     |
...
| [opencode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Canopy plugin 개발을 위한 템플릿입니다.                              |
| [opencode.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | terminal 기반 AI 코딩 agent인 opencode용 Neovim frontend입니다.        |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | `@opencode-ai/sdk`로 Canopy를 사용하는 Vercel AI SDK provider입니다. |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Canopy용 Web/Desktop App 및 VS Code Extension입니다.                 |
| [Canopy-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian UI에 Canopy를 내장하는 Obsidian plugin입니다.               |
