...
L'[ID de modèle](/docs/config/#models) dans votre configuration Canopy utilise le format `Canopy-go/<model-id>`. Par exemple, pour Kimi K2.7 Code, vous utiliseriez `Canopy-go/kimi-k2.7-code` dans votre configuration.
