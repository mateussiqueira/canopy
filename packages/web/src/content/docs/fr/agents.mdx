...
L'ID de modèle dans votre configuration Canopy utilise le format `provider/model-id`. Par exemple, si vous utilisez [Canopy Zen](/docs/zen), vous utiliserez `opencode/gpt-5.1-codex` pour GPT 5.1 Codex.
