...
Le [model id](/docs/config/#models) dans votre configuration Canopy utilise le format `Canopy/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `canopy/gpt-5.5` dans votre configuration.
