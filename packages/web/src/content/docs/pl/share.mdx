---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące Canopy.
---

Funkcja udostępniania Canopy umożliwia tworzenie publicznych linków do konwersacji Canopy, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, Canopy:
...
Canopy obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie Canopy korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `canopy.json.guard` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu Canopy w Twojej organizacji.
