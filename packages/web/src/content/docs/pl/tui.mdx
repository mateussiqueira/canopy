---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala Canopy.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Canopy zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie Canopy uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI Canopy, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do Canopy. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij Canopy. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `canopy.json.guard`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Canopy czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `Canopy.default`.
