...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Zen` i przejdź do [canopy.dev/auth](https://canopy.dev/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `OpenCode Go` i przejdź do [canopy.dev/auth](https://canopy.dev/zen).
