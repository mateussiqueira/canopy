...
1. Uruchom polecenie `/connect` w TUI, wybierz opencode i przejdź do [canopy.dev/auth](https://canopy.dev/auth).
...
Oto [przykładowa rozmowa](https://canopy.dev/s/4XP1fce5) z opencode.
