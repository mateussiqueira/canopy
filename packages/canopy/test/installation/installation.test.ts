...
import { InstallationChannel } from "@canopystack/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("mateussiqueira/tap/canopy")) return ""
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("mateussiqueira/tap/canopy") && args.includes("--formula")) return "opencode"
