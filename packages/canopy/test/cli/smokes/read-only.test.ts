...
describe("opencode read-only commands (smoke)", () => {
  ...
  // CANOPY_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh CANOPY_TEST_HOME means
  ...
  // in production it'd be a path under CANOPY_TEST_HOME / XDG_DATA_HOME.
