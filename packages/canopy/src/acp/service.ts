...
import type { Message, OpencodeClient, SessionMessageResponse } from "@canopystack/sdk/v2"
...
function fromUnknownError(error: unknown, service?: string): Error {
  ...
  return new ACPError.ServiceFailureError({ safeMessage: "Canopy service failure", service })
}
