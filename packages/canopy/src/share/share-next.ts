...
import type * as SDK from "@canopystack/sdk/v2"
...
import { SessionShareTable } from "@canopystack/core/share/sql"
...
const disabled = process.env["CANOPY_DISABLE_SHARE"] === "true" || process.env["CANOPY_DISABLE_SHARE"] === "1" || process.env["OPENCODE_DISABLE_SHARE"] === "true" || process.env["OPENCODE_DISABLE_SHARE"] === "1"
