...
import { PermissionV1 } from "@canopystack/core/v1/permission"
import { Slug } from "@canopystack/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@canopystack/llm"
...
import { PartTable, SessionTable } from "@canopystack/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@canopystack/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".canopy", "plans")
