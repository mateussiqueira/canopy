...
import { buildPrompt } from "@canopystack/core/session/compaction"
...
export const PRUNE_MINIMUM = 25_000
export const PRUNE_PROTECT = 30_000
const TOOL_OUTPUT_MAX_CHARS = 1_500
const PRUNE_PROTECTED_TOOLS = ["skill", "read", "grep", "glob"]
