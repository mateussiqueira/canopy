...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@canopystack/plugin"
...
export function webSearchEnabled(providerID: ProviderV2.ID, flags = { exa: false, parallel: false }) {
  return providerID === ProviderV2.ID.canopy || flags.exa || flags.parallel
}
