...
import { EventSequenceTable, EventTable } from "@canopystack/core/event/sql"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CANOPY_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CANOPY_WORKSPACE_ID: config.id,
        CANOPY_EXPERIMENTAL_WORKSPACES: "true",
