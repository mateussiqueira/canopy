...
import { normalizePromptContent } from "@canopystack/tui/editor"
...
import { CANOPY_BASE_MODE, useBindings } from "@canopystack/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Canopy" } satisfies SlashOption,
    ]
