...
import { Hash } from "@canopystack/core/util/hash"
...
import { optionalOmitUndefined } from "@canopystack/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@canopystack/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
      ...
      Effect.succeed({
        ...
        options: {
          headers: {
            "HTTP-Referer": "https://canopy.dev/",
            "X-Title": "canopy",
            "X-BILLING-INVOKE-ORIGIN": "Canopy",
          },
        },
      }),
    vercel: () =>
