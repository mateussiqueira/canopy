...
import { ProjectDirectoryTable, ProjectTable } from "@canopystack/core/project/sql"
import { ProjectDirectories } from "@canopystack/core/project/directories"
...
import { which } from "@canopystack/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@canopystack/core/schema"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.CANOPY_FAKE_VCS)
