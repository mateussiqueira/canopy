import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@canopystack/llm"
...
// Move this extraction into @canopystack/llm when Copilot is handled by the native runtime.
