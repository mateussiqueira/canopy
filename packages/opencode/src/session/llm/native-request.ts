import type { JsonSchema, LLMRequest, ProviderMetadata } from "@canopystack/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@canopystack/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @canopystack/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
