...
import { llmClient } from "@canopystack/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@canopystack/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@canopystack/llm/route"
import type { LLMClientService } from "@canopystack/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @canopystack/llm. It
