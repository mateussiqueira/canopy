...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CANOPY_CALLER", () => {
    process.env["CANOPY_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CANOPY_CALLER", () => {
    process.env["CANOPY_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CANOPY_CALLER", () => {
    process.env["CANOPY_CALLER"] = "unknown"
