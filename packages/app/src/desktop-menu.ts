...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "OpenCode Documentation", href: "https://canopy.dev/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/mateussiqueira/canopy/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/mateussiqueira/canopy/issues/new?template=bug_report.yml",
      },
    ],
  },
]
