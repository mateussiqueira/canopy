export const dict = {
  ...
  "dialog.provider.canopy.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.canopy.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.canopyGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Canopy",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Canopy.",
  ...
  "provider.connect.canopyZen.line1":
    "Canopy Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.canopyZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.canopyZen.visit.prefix": "Visite ",
  "provider.connect.canopyZen.visit.link": "opencode.ai/zen",
  "provider.connect.canopyZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Canopy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Canopy.",
  ...
  "dialog.server.description": "Trocar para qual servidor Canopy este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Canopy ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Canopy",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Canopy ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Canopy inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Canopy dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Canopy",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Canopy aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Canopy segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Canopy é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Canopy iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Canopy.",
