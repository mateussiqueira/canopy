export const dict = {
  ...
  "dialog.provider.canopy.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.canopy.tagline": "Reliable optimized models",
  "dialog.provider.canopyGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Canopy",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Canopy.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.canopyZen.line1":
    "Canopy Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.canopyZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.canopyZen.visit.prefix": "Visit ",
  "provider.connect.canopyZen.visit.link": "opencode.ai/zen",
  "provider.connect.canopyZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Canopy.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Canopy.",
  ...
  "dialog.server.description": "Switch which Canopy server this app connects to.",
  ...
  "wsl.onboarding.step.canopy": "Canopy",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Canopy...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Canopy in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Canopy...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Canopy in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Canopy in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Canopy",
  "wsl.onboarding.canopyReadyIn": "Canopy is ready in {{distro}}.",
  "wsl.onboarding.canopyReady": "Canopy is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Canopy in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Canopy",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Canopy.",
  ...
  "toast.update.description": "A new version of Canopy ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Canopy team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Canopy does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Canopy includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Canopy Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Canopy server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Canopy",
  ...
  "settings.general.row.appearance.description": "Customise how Canopy looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Canopy follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Canopy is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Canopy launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Canopy.",
