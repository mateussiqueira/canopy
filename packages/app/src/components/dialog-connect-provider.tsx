import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@canopystack/sdk/v2/client"
...
import { List, type ListRef } from "@canopystack/ui/list"
        ...
        <Switch>
          <Match when={provider().id === "opencode"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.canopyZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.canopyZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.canopyZen.visit.prefix")}
                <Link href="https://opencode.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.canopyZen.visit.link")}
                </Link>
                {language.t("provider.connect.canopyZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
