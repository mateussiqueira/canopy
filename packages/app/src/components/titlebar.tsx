...
import { Tooltip, TooltipKeybind } from "@canopystack/ui/tooltip"
import { useTheme } from "@canopystack/ui/theme/context"
import { IconButtonV2 } from "@canopystack/ui/v2/icon-button-v2"
import { Icon as IconV2 } from "@canopystack/ui/v2/icon"
import { KeybindV2 } from "@canopystack/ui/v2/keybind-v2"
import { TooltipV2 } from "@canopystack/ui/v2/tooltip-v2"
...
import { Session } from "@canopystack/sdk/v2"
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_CANOPY_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_CANOPY_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
