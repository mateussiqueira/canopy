...
const opencodeClient = process.env.CANOPY_CLIENT

afterEach(() => {
  if (otelResourceAttributes === undefined) delete process.env.OTEL_RESOURCE_ATTRIBUTES
  else process.env.OTEL_RESOURCE_ATTRIBUTES = otelResourceAttributes

  if (opencodeClient === undefined) delete process.env.CANOPY_CLIENT
  else process.env.CANOPY_CLIENT = opencodeClient
})
