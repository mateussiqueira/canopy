...
declare const CANOPY_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CANOPY_LIBC === "undefined" ? undefined : CANOPY_LIBC
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CANOPY_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.CANOPY_EXPERIMENTAL_FILEWATCHER) {
