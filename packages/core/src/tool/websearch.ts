...
import { ToolFailure } from "@canopystack/llm"
...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.CANOPY_WEBSEARCH_PROVIDER === "exa" || process.env.CANOPY_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.CANOPY_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("CANOPY_EXPERIMENTAL") || truthy("CANOPY_ENABLE_EXA") || truthy("CANOPY_EXPERIMENTAL_EXA"),
    enableParallel: truthy("CANOPY_ENABLE_PARALLEL") || truthy("CANOPY_EXPERIMENTAL_PARALLEL"),
