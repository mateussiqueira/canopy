...
export const TypeId: TypeId = "~@canopystack/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@canopystack/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@canopystack/effect-sqlite-node/NodeSqliteClient")
